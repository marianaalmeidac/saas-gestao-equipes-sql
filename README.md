...
- Uso de aliases para melhorar a leitura das consultas
...
- `inserts.sql` – inserção de dados de usuários, planos, recursos e assinaturas  
- `exercicios_resolvidos.sql` – desafios práticos envolvendo métricas e relatórios  
